...
<head>
    ...
    <title>Akıllı Eldiven - Bütünleşik Kılavuz</title>
    ...
    <style>
        ...
        * {
        ...
        .details-card-header .section-title-text {
            display: flex;
            align-items: center;
            gap: 1rem;
        }
        ...
        #ai-modal-overlay #ai-inspector-wrapper {
            max-width: 70%;
            width: 70%;
            max-height: 80vh;
            display: flex;
        ...
        .interactive-map-svg .block:hover {
